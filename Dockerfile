...
RUN apt update && apt install nano assetfinder libpcap-dev kali-desktop-base kali-themes-common kali-wallpapers-2023 kali-defaults kali-tweaks kali-menu xfce4-panel-profiles kali-themes openjdk-24-jdk -y
